...
| **<p align="center">wheel</p>** <br/> <img src="media/scenarios/wheel.gif"/>         | **<p align="center">balance</p>** <br/> <img src="media/scenarios/balance.gif"/>   | **<p align="center">reverse <br/> transport</p>** <br/> <img src="media/scenarios/reverse_transport.gif"/> |
| **<p align="center">give_way</p>** <br/> <img src="media/scenarios/give_way.gif"/>   | **<p align="center">passage</p>** <br/> <img src="media/scenarios/passage.gif"/>   | **<p align="center">dispersion</p>** <br/> <img src="media/scenarios/dispersion.gif"/>                     |
| **<p align="center">waterfall</p>** <br/> <img src="media/scenarios/waterfall.gif"/> |                                                                                    |                                                                                                            |


| Env name               | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | GIF                                                                           |
|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| `waterfall.py`         | Debug environment. `n_agents` agents are spawned in the top of the environment. Each agent is rewarded based on how close it is to the center of the black line at the bottom. Agents have to reach the line and in doing so they might collide with each other and with boxes in the environment.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | <img src="media/scenarios/waterfall.gif" alt="drawing" width="5000"/>         |
