...
class Scenario(BaseScenario):
    ...
    def parameters(self) -> List:
        return [self.distance_between_goals]

    def to_log(self) -> Dict:
        return {
            "distance_between_goals": self.distance_between_goals.item(),
            "distance_between_goals_bounded": self.distance_between_goals.sigmoid().item(),
        }
