...
class Sensor(ABC):
    def __init__(self, world: maps.simulator.core.World):
        super().__init__()
        self._world = world
        self._agent: Union[maps.simulator.core.Agent, None] = None

    @property
    def agent(self) -> Union[maps.simulator.core.Agent, None]:
        return self._agent

    @agent.setter
    def agent(self, agent: maps.simulator.core.Agent):
        self._agent = agent
...
class Lidar(Sensor):
    def __init__(
        self,
        world: maps.simulator.core.World,
